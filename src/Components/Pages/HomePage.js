...
const HomePage = () => {
  ...
  const svgLoc = 
    '<svg style="margin-bottom:7px;" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#E2E8F0"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800q-101 0-170.5 69.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>'
  const svgDates = '<svg style="margin-bottom:9px;" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#E2E8F0"><path d="M580-240q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29ZM200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Zm0-480h560v-80H200v80Zm0 0v-80 80Z"/></svg>'
  ...
  main.innerHTML = `
  <div id="upper-left">
    <h6 id="hashtag">#JaiKi <span id="letter-a">A</span>ish</h6>
  </div>
  <div id="upper-right">
    <span id="time-remaining-v-days" class="time-remaining-value"></span>
  </div>
  <div id="home-container">
    ...
    <div id="home-img-div">
      ...
      <div id="text-container">
        ...
        <h3 id="subtitle">For the wedding of </h3>
        <div id="namespace"> 
          <div id="name1"><span id="first-letter">A</span>shmita</div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content form-card">
      <button id="modal-exit-btn" >
        <span class="material-symbols-outlined" id="exit-span">
          close
        </span>
      </button>
      <div class="modal-body text-center opacity-100 form-card">
  ...
  // const metaElement = document.getElementsByTagName("meta")[2];
  // metaElement.content = `https://jaiwedsaish.netlify.app${icon}`
  let clicks = 0;
  ...
  const dateWedding = new Date("2024-10-27");

  // Calcul de la différence en millisecondes entre les deux dates
const difference = dateWedding - dateNow;

// Calcul du nombre de jours
const days = Math.floor(difference / (1000 * 60 * 60 * 24));
// Calcul du reste des millisecondes après soustraction des jours
const remainingMilliseconds = difference % (1000 * 60 * 60 * 24);

// Calcul du nombre d'heures
const hours = Math.floor(remainingMilliseconds / (1000 * 60 * 60));
// Calcul du reste des millisecondes après soustraction des heures
...
const daysElement = document.getElementById("time-remaining-v-days");
const text = `${days+1} days to go`

daysElement.innerHTML = text; // Effacer le contenu actuel pour placer chaque lettre dans un conteneur séparé
